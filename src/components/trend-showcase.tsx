...
export function TrendShowcase({
  ...
  const panel = (
    <div
      className={cn(
        "relative overflow-hidden rounded-lg shadow-soft ring-1 ring-white/55",
        theme.washClass,
        embedded && "h-full min-h-[280px]",
      )}
    >
      <SafeProductImage
        src={theme.heroImage}
      ...
      >
        ...
        >
          ...
          <h2 className={cn("mt-4 font-black leading-none tracking-tight", theme.textClass, title ? "text-4xl md:text-5xl lg:text-6xl" : "text-4xl md:text-5xl")}>
            {headline}
          </h2>
  ...
  return <section className="store-container py-4 md:py-5">{panel}</section>;
}
