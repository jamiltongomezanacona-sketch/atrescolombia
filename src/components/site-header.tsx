  ...
  return (
    <header className="store-header-shell text-white" aria-label="Cabecera ATRES">
      <div className="store-header-glass hidden border-b lg:block">
        <div className="header-container flex items-center justify-between gap-3 py-1 text-[10px] font-normal tracking-wide text-white/75">
      ...
      <div className="hidden lg:block">
        <Suspense fallback={<div className="store-header-nav h-6" />}>
