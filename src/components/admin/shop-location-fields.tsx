  ...
  return (
    <section className="grid min-w-0 max-w-full gap-3 rounded-xl border border-[#d8e7f5] bg-white p-3 md:p-4">
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          <p className="text-[11px] font-black uppercase tracking-wide text-[#2f6f9f]">Ubicacion</p>
          <h2 className="mt-1 text-base font-black tracking-tight text-zinc-950 md:text-lg">
      ...
      <p className="text-xs font-medium leading-5 text-zinc-500" role="status" aria-live="polite">
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        <label className="flex min-h-11 items-center gap-3 rounded-xl border border-[#d8e7f5] bg-[#eef6ff]/70 px-3 text-sm font-bold">
          <input
            name="pickup_enabled"
            type="checkbox"
