  ...
  return (
    <>
      <button
        ref={triggerRef}
        type="button"
        className="atres-interactive inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-[var(--radius-card)] text-white/90 transition hover:bg-white/10 hover:text-gold-light lg:hidden"
        aria-expanded={open}
