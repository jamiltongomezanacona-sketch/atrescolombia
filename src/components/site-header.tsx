    ...
    <header className="sticky top-0 z-40 bg-black text-white shadow-[0_10px_34px_rgba(0,0,0,0.16)]">
      ...
      <div className="mx-auto grid max-w-[1500px] items-center gap-3 px-3 py-3 sm:px-4 md:grid-cols-[220px_1fr_300px]">
        ...
        <form action="/buscar" className="mx-auto flex h-11 w-full max-w-3xl overflow-hidden rounded-full bg-white text-black shadow-[0_0_0_1px_rgba(255,255,255,0.18)]">
          ...
          />
          <button className="inline-flex w-14 items-center justify-center bg-white text-black ring-1 ring-black/10 transition hover:bg-amber-100 sm:w-28 sm:gap-2" type="submit">
            <SearchIcon />
      ...
      <nav className="border-t border-white/10 bg-black">
        <div className="mx-auto flex max-w-[1500px] gap-1 overflow-x-auto px-3 py-2 text-sm font-bold [scrollbar-width:none] sm:px-4">
