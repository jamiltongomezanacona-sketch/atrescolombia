...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className={`theme-whatsapp-button atres-interactive fixed z-20 grid size-12 place-items-center rounded-full transition duration-200 ease-out hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-whatsapp md:size-[3.25rem] ${
        compactCatalog
...
function WhatsAppIcon() {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 32 32"
      className="relative z-[1] size-[1.45rem] md:size-[1.55rem]"
      fill="currentColor"
